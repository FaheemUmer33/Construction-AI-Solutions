      ...
      <div className="p-5">
        ...
        <div className="mt-5">
          ...
          <div className="h-1.5 overflow-hidden rounded-full bg-white/10">
            <div className="h-full rounded-full bg-gradient-to-r from-cas-light to-cas-mint transition-all duration-700 group-hover:shadow-[0_0_18px_rgba(165,199,183,0.45)]" style={{ width: `${progress}%` }} />
          </div>
        </div>
      </div>
    </Link>
