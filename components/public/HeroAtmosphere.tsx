...
export function HeroAtmosphere() {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_22%_18%,rgba(223,243,233,0.15),transparent_28%),radial-gradient(circle_at_80%_12%,rgba(165,199,183,0.14),transparent_32%)]" />
      <motion.div
      ...
      >
        <svg viewBox="0 0 1440 260" className="h-full w-full" preserveAspectRatio="none" aria-hidden="true">
          <path d="M0 230H1440V260H0V230Z" fill="rgba(2,51,30,0.88)" />
          <path d="M90 230V70H120V230M105 70H305M180 70V230M120 100H260M1170 230V42H1200V230M1185 42H1395M1252 42V230M1200 76H1350" stroke="rgba(232,227,216,0.35)" strokeWidth="6" />
          <path d="M420 230V125H545V230M575 230V95H720V230M760 230V145H850V230" fill="rgba(27,75,54,0.9)" stroke="rgba(223,243,233,0.28)" strokeWidth="3" />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-steel/10 via-steel/72 to-cas-forest" />
    </div>
  );
}
