...
export function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <article className="industrial-card rounded-lg p-6 transition duration-300 hover:-translate-y-1 hover:border-safety/50 hover:bg-white/[0.07]">
      <div className="mb-5 grid h-12 w-12 place-items-center rounded bg-safety/15 text-safety">
        <Icon />
      </div>
